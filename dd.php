...
<html lang="en">
  ...
  <body>
      ...
      <div id="content" class="p-4 p-md-5">
        ...
        <h2 class="mb-4">Welcome to the Donors</h2>
...
?>
       ...
       <table class="table table-bordered " style="background-color:  #d2a679">
...

{
   ...
   <td>  <a href='edit.php? fname=$result[fname]& lname=$result[lname]&cnic=$result[cnic]&date=$result[date]&phoneno=$result[phoneno]&city=$result[city]&state=$result[state]&donationtype=$result[donationtype]&donations=$result[donations]' > Edit</a> </td>

                <td><a href='dd.php?fname=$result[fname]' > Delete </a></td>
...
?>
  ...
  <?php
   ...
   $fname =$_GET['fname'];
        ...
        $query="DELETE FROM common WHERE fname='$fname'";
